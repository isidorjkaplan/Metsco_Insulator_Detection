...
def printHistory(history):
    ...
    plt.title('Object detection (has insulator or not)')
...
epochs = 150
train_data_dir = "/data/old/insulator_or_not/train"
validation_data_dir = '/data/old/insulator_or_not/validation'
networkFile = 'has_insulator.h5'
batch_size = 16
